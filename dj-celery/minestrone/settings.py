...
with open('/home/bmehta/environment.json') as f:
...
BROKER_HOST = dotcloud_env['RABBITMQ_HOST']
BROKER_PORT = int(dotcloud_env['RABBITMQ_PORT'])
BROKER_USER = dotcloud_env['RABBITMQ_LOGIN']
BROKER_PASSWORD = dotcloud_env['RABBITMQ_PASSWORD']
BROKER_VHOST = dotcloud_env['RABBITMQ_VIRTUALHOST']
...
MEDIA_ROOT = '/home/bmehta/data/media/'
...
STATIC_ROOT = '/home/bmehta/volatile/static/'
